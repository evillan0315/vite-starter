...
export function HomePage(): JSX.Element {
  ...
  return (
    <Box className="flex flex-1 items-center justify-center px-6 py-12">
      <Paper elevation={2} className="w-full max-w-3xl rounded-2xl p-10">
        <Stack spacing={4} alignItems="center" textAlign="center">
          ...
          <Typography color="text.secondary" maxWidth={640}>
            This starter provides authentication, feature-based architecture,
            routing, layouts, global loading, theming, state management, and
            scalable project organization for production-ready applications.
          </Typography>
